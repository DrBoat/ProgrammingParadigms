 ...
 */
public class FunctionalExpressionTest extends BaseJavascriptTest<jstest.Engine> {
    ...
    protected FunctionalExpressionTest(final Language language, final boolean testParsing) {
        super(new JSEngine("src/jstest/functional/functionalExpression.js", ""), language, testParsing);
    }
